...
namespace DataJuggler.Net.Core
{
	...
	{  
		...
		#region Methods
			...
			{
				// Create StringBuilder
				return "Load(DataJuggler.Net.Core.DataRow row) +2 overides";
			}
			#endregion
			...
			#region WriteChangesProperty(DataJuggler.Net.Core.DataTable table) void
			private void WriteChangesProperty(DataJuggler.Net.Core.DataTable table,DataJuggler.Net.Core.DataField Field)
			{
				// locals
			...
			#region WriteExportToDataRowMethod(DataJuggler.Net.Core.DataRow dataTable)
			private void WriteExportToDataRowMethod(DataJuggler.Net.Core.DataTable dataTable)
			{
				...
				line = "public DataJuggler.Net.Core.DataRow ExportToDataRow()";
				WriteLine(line);
                ...
                WriteLine("DataJuggler.Net.Core.DataRow dataRow = new DataJuggler.Net.Core.DataRow(this.table);");
			...
			public void WriteFieldChangesGet(DataJuggler.Net.Core.DataField Field,DataJuggler.Net.Core.DataTable table)
			{
			...
			private void WriteLoadMethodFromDataRow(DataJuggler.Net.Core.DataTable table)
			{
				...
				BeginRegion("Load(DataJuggler.Net.Core.DataRow row)");
				
				// Function Declaration
				line = "public void Load(DataJuggler.Net.Core.DataRow row)";
				WriteLine(line);
			...
			private void WriteProperties(DataJuggler.Net.Core.DataTable table)
			{
				...
				if(!BusinessObjectPass)
				{
				    ...
				    if ((table.HasPrimaryKey) && (!table.IsView))
				    {
					    ...
					    DataJuggler.Net.Core.DataField DelField = new DataField();
